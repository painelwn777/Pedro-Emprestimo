...
ou <b>não tenho interesse</b>.`;
    ...
    // 🆕 PROVA SOCIAL (Exibida antes do checkout)
    provaSocial() {
      return `👀 <b>VEJA QUEM JÁ FOI LIBERADO HOJE:</b><br><br>
      
      <b>1. João (Urgente):</b> Liberado R$ 5.000 em 20min!<br>
      <img src="imagens/comprovantes/joao.jpg" style="width:100%; border-radius:12px; margin-bottom:10px; border: 1px solid #ddd;"><br>
      
      <b>2. Maria (Medo de Golpe):</b> Recebeu R$ 3.000 em menos de 30min!<br>
      <img src="imagens/comprovantes/maria.jpg" style="width:100%; border-radius:12px; margin-bottom:10px; border: 1px solid #ddd;"><br>
      
      <b>3. Carlos (Nome Sujo):</b> R$ 2.000 liberados mesmo negativado!<br>
      <img src="imagens/comprovantes/carlos.jpg" style="width:100%; border-radius:12px; margin-bottom:10px; border: 1px solid #ddd;"><br>
...
<b>ENVIADO</b>, <b>FEITO</b>, <b>PRONTO</b>, <b>OK</b> ou <b>CONCLUÍDO</b>.`;
    ...
    // Etapa 4 - Checkout + Botão Telegram
    checkoutLink(nome) {
